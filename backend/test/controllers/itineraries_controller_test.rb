...
class ItinerariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post itineraries_url, params: { itinerary: { lat1: @itinerary.lat1, lat2: @itinerary.lat2, lon1: @itinerary.lon1, lon2: @itinerary.lon2 } }
    end
  ...
  test "should update itinerary" do
    patch itinerary_url(@itinerary), params: { itinerary: { lat1: @itinerary.lat1, lat2: @itinerary.lat2, lon1: @itinerary.lon1, lon2: @itinerary.lon2 } }
